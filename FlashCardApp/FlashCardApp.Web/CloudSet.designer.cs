...
namespace FlashCardApp.Web
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="FlashCardDb")]
	public partial class CloudSetDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteCloudUser(CloudUser instance);
		...
		public CloudSetDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["FlashCardDbConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public CloudSetDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CloudSetDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CloudSetDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CloudSetDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnSetIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CloudFlashCardSet_CloudFlashCard", Storage="_CloudFlashCardSet", ThisKey="SetID,OwnerID", OtherKey="ID,UserID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnUserIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CloudUser_CloudFlashCardSet", Storage="_CloudUser", ThisKey="UserID", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
